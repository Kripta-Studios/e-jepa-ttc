...
from scripts.pretrain_eap_tubelet_jepa import main as pretrain_tubelet_main
from scripts.train_e_jepa_tubelet_lhr import _metrics, _predict, load_training_spec, train_epoch
...
def test_tubelet_pretraining_does_not_relabel_legacy_encoder() -> None:
    with pytest.raises(SystemExit) as failure:
        pretrain_tubelet_main(
            [
                "--eap-root",
                "unused",
                "--config",
