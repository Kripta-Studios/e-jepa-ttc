...
$onnxCheckpoint = Invoke-Python @chkArgs
...
$exportArgs = @("scripts/export_onnx.py", "--checkpoint", $onnxCheckpoint, "--output", $onnxOut, "--cache", "artifacts/features/evttc_full_starter_voxel_160x90_b5_raw_meta_nav.npz", "--validation-split", "validation", "--sample-count", "32")
