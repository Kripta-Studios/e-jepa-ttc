...
**Estado:** protocolo v6: inventario de datos cerrado, Garl-TTC entrenado con EvTTC-32 y pretraining opcional eAP-40, Benchmark-10 sellado  
**Fecha:** 29 de julio de 2026  
**Repositorio base:** `Kripta-Studios/e-jepa-ttc`  
**Rama de referencia:** `scientific-recovery-v3-hardening`  
**Commit experimental de referencia:** `f533f2b63e4e7244c186372ba8f836688522c234`  
...
Resultados provisionales de seed 7:

| Brazo | MAE validation | RMSE | Error relativo |
|---|---:|---:|---:|
| `BASE` | **0,323 s** | **0,584 s** | 8,16 % |
